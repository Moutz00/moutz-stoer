...
<div class="products-container">
    ...
    <div class="product-card">
         ...
         <div class="product-description">سماعة رأس استريو لاسلكية عالية الجودة مع بطارية تدوم 30 ساعة وتقنية إلغاء الضوضاء النشطة</div>
...
<div class="products-container">
    ...
    <div class="product-card">
         ...
         <div class="product-price">29.99 شيكل</div>
         <button class="product-button">أضف للسلة</button>
    </div>
    ...
    <div class="product-card">
         ...
         <div class="product-name">المنتج 2</div>
         <div class="product-description">وصف المنتج 2</div>
         <div class="product-price">39.99 شيكل</div>
         <button class="product-button">أضف للسلة</button>
    </div>
    ...
    <div class="product-card">
         ...
         <div class="product-name">المنتج 4</div>
         <div class="product-description">وصف المنتج 4</div>
         <div class="product-price">59.99 شيكل</div>
         <button class="product-button">أضف للسلة</button>
    </div>
</center>
...
<div class="products-container">
    ...
    <div class="product-card">
         ...
         <div class="product-name">المنتج 1</div>
         <div class="product-description">وصف المنتج 1</div>
         <div class="product-price">89.99 شيكل</div>
         <button class="product-button">أضف للسلة</button>
    </div>
    ...
    <div class="product-card">
         ...
         <div class="product-name">المنتج 2</div>
         <div class="product-description">وصف المنتج 2</div>
         <div class="product-price">129.99 شيكل</div>
         <button class="product-button">أضف للسلة</button>
    </div>
